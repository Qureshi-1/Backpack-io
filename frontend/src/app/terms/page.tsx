    ...
    <div className="min-h-screen bg-black text-zinc-300">
      ...
      <main className="max-w-3xl mx-auto px-6 pt-32 pb-24">
        ...
        <div className="space-y-8 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mb-4">3. User Accounts & API Keys</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mb-4">7. Disclaimer of Warranties & Limitation of Liability</h2>
            <p>
